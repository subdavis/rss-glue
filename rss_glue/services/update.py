    ...
    try:
        ...
        for post_data in posts_data:
            ...
            if not existing:
                ...
                post_data["content"] = handler.process_post_content(
                    post_data.get("content"), feed.config
                )
                ...
                print(
                    f"Updated score for existing post: {existing.external_id} to {existing.score}"
                )
